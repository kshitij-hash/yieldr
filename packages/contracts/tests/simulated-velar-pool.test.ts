...
/*
 * Simulated Velar Pool Contract Tests
 *
 * This contract simulates a Velar STX-sBTC pool on testnet for user experience testing.
 * It accepts sBTC deposits, tracks positions, and calculates yield based on mainnet APY data.
 */

describe("simulated-velar-pool", () => {
  beforeEach(() => {
    simnet.setEpoch("3.0");
  });
  ...
  describe("yield calculation", () => {
    beforeEach(() => {
      // Set APY in oracle (10.80% = 1080 basis points - Velar's rate)
      simnet.callPublicFn(
        "pool-oracle",
    ...
    it("should calculate yield based on time elapsed and APY", () => {
      ...
      // With 10.80% APY and 100 blocks, expect some positive yield
