;; title: simulated-alex-pool
;; version: 1.0.0
;; summary: Simulated ALEX STX-sBTC pool for testnet user experience
;; description: This contract simulates the ALEX pool functionality on testnet.
...
(define-private (calculate-yield (user principal))
  (let (
    ...
    (if (is-eq balance u0)
      u0
      (let (
        (apy-basis-points (unwrap-panic (contract-call? .pool-oracle get-alex-apy)))
